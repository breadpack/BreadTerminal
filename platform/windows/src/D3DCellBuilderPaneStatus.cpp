...
void D3DTextRenderer::Impl::buildPaneStatusOverlays(float cellW, float cellH,
                                                     float ascent,
                                                     float fontSize) {
    ...
    // Status pills in the status bar: laid out left-to-right after left_text
